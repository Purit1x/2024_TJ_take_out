...
namespace takeout_tj.Migrations
{
    ...
    [Migration("20240825052248_liliang8.25.13.22")]
    partial class liliang8251322
    {
            ...
            modelBuilder.Entity("takeout_tj.Models.Platform.OrderCouponDB", b =>
                {
                    ...
                    b.Property<int>("UserCouponDBCouponId")
                        .HasColumnType("NUMBER(10)");

                    b.Property<DateTime>("UserCouponDBExpirationDate")
                        .HasColumnType("TIMESTAMP(7)");

                    b.Property<int>("UserCouponDBUserId")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.HasIndex("UserCouponDBUserId", "UserCouponDBCouponId", "UserCouponDBExpirationDate");
            ...
            modelBuilder.Entity("takeout_tj.Models.Platform.OrderCouponDB", b =>
                {
                    ...
                    b.HasOne("takeout_tj.Models.User.UserCouponDB", "UserCouponDB")
                        ...
                        .HasForeignKey("UserCouponDBUserId", "UserCouponDBCouponId", "UserCouponDBExpirationDate")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
