        ...
        <div v-else>
            ...
            <div v-if="currentOrder.state === 3" class="comment-section">
                ...
                <el-form :rules="newOrderComment" ref="refForm" :model="currentOrder">
                    <el-form-item label="商家评分" prop="merchantRating"><input v-model="currentOrder.merchantRating"
                            placeholder="商家评分" @blur="validateField('merchantRating')" /></el-form-item>
                    <el-form-item label="骑手评分" prop="riderRating"><input v-model="currentOrder.riderRating"
                            placeholder="骑手评分" @blur="validateField('riderRating')" /></el-form-item>
                    <el-form-item label="评价" prop="comment"><input v-model="currentOrder.comment"
                            placeholder="评价" /></el-form-item>
                </el-form>
